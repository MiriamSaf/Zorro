    ...
    public partial class Initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payees", x => x.BillerCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BpayBillerCode = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillPays_Payees_BpayBillerCode",
                        column: x => x.BpayBillerCode,
                        principalTable: "Payees",
                        principalColumn: "BillerCode",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillPays_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillPays_BpayBillerCode",
                table: "BillPays",
                column: "BpayBillerCode");

            migrationBuilder.CreateIndex(
                name: "IX_BillPays_TransactionId",
                table: "BillPays",
